          ...
          <div className="col-xs-18 col-xs-offset-3 col-md-12 col-md-offset-6">
            ...
            <div className="row space-1">
              <div className="col-xs-12 col-xs-offset-6">
                <img src="img/projects/ihedude.png"/>
              </div>
            </div>
            ...
            <WebImageDisplay src="img/projects/bunnymark.jpg" href="//www.goodboydigital.com/pixijs/bunnymark" target="_blank"/>
            ...
            <WebImageDisplay src="img/projects/ihe.png" href="//juliahw.github.io/i-hate-everyone" target="_blank"/>
          </div>
        </div>
      </div>
    );
