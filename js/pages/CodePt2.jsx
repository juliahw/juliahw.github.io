    ...
    return (
      <div className="fade-in">
        ...
        <div className="col-xs-18 col-xs-offset-3 col-md-12 col-md-offset-6">
          ...
          <p>
            After researching different choices for frontend frameworks, we decided on <a href="//ionicframework.com/" target="_blank">Ionic</a>, a hybrid app framework built on <a href="//angularjs.org" target="_blank">Angular</a>. Using Ionic speeded up our workflow significantly, as it gave us multi-platform functionality and built-in components for free.
          </p>
          <p>
